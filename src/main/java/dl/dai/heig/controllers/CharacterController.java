...
public class CharacterController {
    ...
    public CharacterController(ConcurrentHashMap<Integer, Character> characters, ConcurrentHashMap<Integer,LocalDateTime> charactersCache) {
    ...
    public void getMany(Context ctx) {
        ...
        if (lastKnownModification != null
                ...
                && charactersCache.get(RESERVED_ID_TO_IDENTIFY_ALL_CHARACTERS).equals(lastKnownModification)){
            throw new NotModifiedResponse();
        }
        LocalDateTime now;
